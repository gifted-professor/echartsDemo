...
export const useChartOptionStore = defineStore("chart", {
    state: () => {
        return {
            option3: {
                title: {
                ...
                series: [
                    {
                        ...
                        data: [20, 28, 40, 33, 68, 55, 42, 33, 11],
                    },
                ],
            },
            option2: {
                ...
                xAxis: {
                    type: "category",
                    data: ["6-27", "6-27", "6-27", "6-27", "6-27", "6-27", "6-27"],
                    axisLabel: {
                        color: "white",
                    },
                },
            ...
            option1: {
                ...
                color: ["#53C8D1", "#59CB74", "#FBD444", "#7F6AAD", "#585247"],
                series: [
                    {
                        name: "",
                        type: "pie",
                        ...
                        data: [
                            { name: "长期空置", value: 10 },
                            { name: "长期未外出", value: 40 },
                            { name: "小孩独自出门超时", value: 60 },
                            { name: "老人独自出门超时", value: 90 },
                        ],
                    },
                ],
            },
